...
function createHireling(){
  ...
  // if(coinFlip() < 1){
    if(coinFlip() < 1){
      hireling1 = characterLayer.create(-30,590, "characters");
    }
    else {
      hireling1 = characterLayer.create(630,590, "characters");

      hireling1.anchor.setTo(.5,.5);
    ...
    clientGame.add.tween(hireling1).to({ x: clientGame.width/2 }, 5000, Phaser.Easing.Linear.None, true);
  // }
  // else{
  //
  // }
