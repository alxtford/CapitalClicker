...
function createHireling(){
  ...
  // if(coinFlip() < 1){
    ...
    hireling1.animations.add("walk", [0,1,2,3,4,5], 10, true);
    hireling1.animations.add("idle", [6,7,8,9,10,11], 2, true);

    tween = clientGame.add.tween(hireling1).to({ x: clientGame.width/2 }, 5000, Phaser.Easing.Linear.None, false);
    tween.onComplete.add(function (){
      hireling1.animations.play("idle");
    }, this);
    tween.start();
    hireling1.animations.play("walk");
    console.log(hireling1);
  // }
  // else{
  //
  // }
